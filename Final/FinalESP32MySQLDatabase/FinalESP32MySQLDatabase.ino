...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://172.26.54.99/Practice-5/Final/getdata.php");  //--> Specify request destination
    ...
    http.begin("http://172.26.54.99/Practice-5/Final/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
